 ...
 * @author santi
 */
public class Tabla_1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reporte de informacion de lideres");
    ...
    public void llenarTabla(){
        ...
        try {
            var allLider = controller.findAllLider();
            DefaultTableModel modelo=(DefaultTableModel) jTable1.getModel();
            
            for (LiderVo lider : allLider) {
              
                String []fila={String.valueOf(lider.getId()),lider.getNombre(),lider.getPrimerApellido(),lider.getCiudadResidencial()};
                modelo.addRow(fila);
            }
